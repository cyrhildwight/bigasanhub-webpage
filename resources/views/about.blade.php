                ...
                <article class="flex-1 bg-white rounded-2xl shadow-md border border-white/40 p-8">
                    ...
                    <ul class="m-0 mt-2 space-y-3">
                        <li class="flex text-start gap-3 text-[#2d3d2a]"><span class="mt-1 text-green-700"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                ...
                                </svg></span><span class="font-semibold text-green-900">Quality</span><span class="sr-only">-</span><span class="ml-11">Commitment to providing the best rice varieties.</span></li>
                        <li class="flex text-start gap-3 text-[#2d3d2a]"><span class="mt-1 text-green-700"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                    <path d="M12 2l7 4v6c0 5-3.5 9.74-7 10-3.5-.26-7-5-7-10V6l7-4z" />
                                </svg></span><span class="font-semibold text-green-900">Integrity</span><span class="sr-only">-</span><span class="ml-9">Transparent operations and fair pricing.</span></li>
                        <li class="flex text-start gap-3 text-[#2d3d2a]"><span class="mt-1 text-green-700"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6">
                                    <path d="M5 13l4 4L19 7" />
                                </svg></span><span class="font-semibold text-green-900">Customer Satisfaction</span><span class="sr-only">-</span><span class="">Ensuring the best buying experience.</span></li>
                    </ul>
                </article>
            </div>
        </div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-700">Complete store setup with branding, equipment, and inventory.</div>
                                </div>
                            </li>
                            <li class="flex gap-3">
                                <span class="mt-1 inline-flex w-5 h-5 items-center justify-center rounded-full bg-green-100 text-green-700">✓</span>
                                <div>
                                    ...
                                    <div class="text-sm text-gray-700">Direct sourcing from trusted rice suppliers and importers.</div>
                                </div>
                            </li>
                            <li class="flex gap-3">
                                <span class="mt-1 inline-flex w-5 h-5 items-center justify-center rounded-full bg-green-100 text-green-700">✓</span>
                                <div>
                                    ...
                                    <div class="text-sm text-gray-700">Promotional materials, digital marketing strategies, and ongoing support.</div>
                                </div>
                            </li>
                            <li class="flex gap-3">
                                <span class="mt-1 inline-flex w-5 h-5 items-center justify-center rounded-full bg-green-100 text-green-700">✓</span>
                                <div>
                                    ...
                                    <div class="text-sm text-gray-700">Guidance on inventory management and financial monitoring.</div>
                                </div>
                            </li>
                        </ul>
                    </div>
