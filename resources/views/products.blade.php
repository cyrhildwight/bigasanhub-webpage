...
@section('content')
        <main>
            <section class="py-[70px] bg-white bg-gradient-to-b from-green-200/60 to-green-300/30 fadein-top">
                <div class="mx-auto w-[92%] max-w-[1200px]">
                    <h1 class="text-center text-3xl md:text-4xl font-extrabold text-green-900 m-0 mb-2 fadein-top">What we offer</h1>
                    ...
                    <div class="grid gap-[22px] sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        @foreach ($items as $i => $item)
                            ...
                            <article class="group relative bg-white rounded-[14px] overflow-hidden border border-[#e7efe8] shadow-md transition-all duration-300 ease-out hover:border-green-700 hover:bg-green-80 hover:shadow-green-700 cursor-pointer {{ $fade }}">
