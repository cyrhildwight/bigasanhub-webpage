...
<style>
    ...
    <div class="mx-auto w-[92%] max-w-[1200px]">
        ...
        <div class="grid gap-6 md:grid-cols-3">
            <!-- Consistent Quality -->
            <article class="bg-white rounded-[14px] shadow-md border border-[#e7efe8] p-6 fadein-left">
            ...
            <article class="bg-white rounded-[14px] shadow-md border border-[#e7efe8] p-6 fadein-top">
                <div class="flex items-center gap-3 mb-2 text-green-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
            ...
            <article class="bg-white rounded-[14px] shadow-md border border-[#e7efe8] p-6 fadein-right">
                <div class="flex items-center gap-3 mb-2 text-green-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
