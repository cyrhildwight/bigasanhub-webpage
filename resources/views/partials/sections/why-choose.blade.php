...
<section class="relative overflow-hidden">
  <!-- Background -->
  <div class="absolute inset-0 bg-[#0a1a0c]">
    <div class="absolute inset-0 bg-gradient-to-r from-emerald-900/40 via-green-900/20 to-emerald-800/40 bg-[length:200%_200%] animate-aurora opacity-90"></div>
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-emerald-900/90 via-black/70 to-green-900/60"></div>
    ...
    <div class="grid lg:grid-cols-12 gap-10 items-stretch">
      ...
      <div class="lg:col-span-5 relative">
        <div id="sticky-features" class="flex flex-col justify-start space-y-8">
          <!-- Feature 1 -->
          <div class="relative flex items-start gap-5 p-8 rounded-xl bg-emerald-500/10 border border-emerald-500/40 backdrop-blur-md transition-all duration-400 overflow-hidden">
            <div class="flex-shrink-0 grid place-items-center w-14 h-14 rounded-xl bg-[linear-gradient(135deg,rgba(34,197,94,0.4),rgba(132,204,22,0.3))] text-emerald-200 shadow-[0_0_20px_rgba(34,197,94,0.6),inset_0_0_10px_rgba(132,204,22,0.25)]">
      ...
      <div class="lg:col-span-7 relative flex flex-col">
        ...
        <div class="mt-8 grid grid-cols-3 gap-4">
          <div class="relative rounded-xl bg-[linear-gradient(145deg,rgba(6,95,70,0.55),rgba(34,197,94,0.18))] border border-emerald-500/40 p-6 text-center transition duration-400 hover:shadow-lg hover:scale-[1.02] after:content-[''] after:absolute after:inset-0 after:rounded-xl after:border after:border-lime-500/25">
